...
<a href="/actions/app_store_connect_api_key/">app_store_connect_api_key</a> | Load the App Store Connect API token to use in other fastlane tools and actions | ios, android, mac
...
Action | Description | Supported Platforms
---|---|---
<a href="/actions/crashlytics/">crashlytics</a> | Refer to [Firebase App Distribution](https://appdistro.page.link/fastlane-repo) | ios, android, mac
