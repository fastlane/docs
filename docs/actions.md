...
<a href="/actions/ensure_xcode_version">ensure_xcode_version</a> | Ensure the right version of Xcode is used
...
<a href="/actions/update_plist">update_plist</a> | Update a plist file
...
<a href="/actions/set_changelog">set_changelog</a> | Set the changelog for all languages on App Store Connect
...
<a href="/actions/upload_to_testflight">upload_to_testflight</a> | Upload new binary to App Store Connect for TestFlight beta testing (via _pilot_)
...
<a href="/actions/upload_to_app_store">upload_to_app_store</a> | Upload metadata and binary to App Store Connect (via _deliver_)
...
<a href="/actions/git_submodule_update">git_submodule_update</a> | Executes a git submodule command
...
<a href="/actions/lane_context">lane_context</a> | Access lane context values
...
<a href="/actions/say">say</a> | This action speaks the given text out loud
...
<a href="/actions/download_dsyms">download_dsyms</a> | Download dSYM files from Apple App Store Connect for Bitcode apps
...
<a href="/actions/println">println</a> | Alias for the `puts` action
<a href="/actions/echo">echo</a> | Alias for the `puts` action
