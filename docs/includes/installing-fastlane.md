...
_fastlane_ supports Ruby versions 2.7 or newer, but prefers Ruby 3.3 or greater. Verify which Ruby version you're using:
...
```sh
WARNING: Support for your Ruby version (3.1.2) is going away. fastlane will soon require Ruby 3.3.0 or newer.
```
