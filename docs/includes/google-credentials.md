...
1. Setup [authentication](https://cloud.google.com/iam/docs/best-practices-service-accounts#choose-when-to-use) using [Workload Identity Federation (GitHub Actions)](#workload-identity-federation-github-actions) or [Service Account Keys](#service-account-keys)
...
_fastlane_ supports two ways to authenticate the service account:
