...
> A sanity check to make sure you are working in a repo that is clean. Especially<br>useful to put at the beginning of your Fastfile in the `before_all` block, if<br>some of your other actions will touch your filesystem, do things to your git repo,<br>or just as a general reminder to save your work. Also needed as a prerequisite for<br>some other actions like `reset_git_repo`.
