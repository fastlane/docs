...
> Specify the URL to download and get the content as a return value<br>For more advanced networking code, use the Ruby functions instead:<br>http://docs.ruby-lang.org/en/2.0.0/Net/HTTP.html
