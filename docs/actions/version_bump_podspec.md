...
> You can use this action to manipulate any 'version' variable contained in a ruby file.<br>For example, you can use it to bump the version of a cocoapods' podspec file.<br>It also supports versions that are not semantic: 1.4.14.4.1<br>For such versions there is an option to change appendix (4.1)
