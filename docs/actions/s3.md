...
----|-------------|--------
  `ipa` | .ipa file for the build  | [*](#dynamic)
  `dsym` | zipped .dsym package for the build  | [*](#dynamic)
  ...
  `access_key` | AWS Access Key ID  | [*](#dynamic)
  `secret_access_key` | AWS Secret Access Key  | [*](#dynamic)
  `bucket` | AWS bucket name | [*](#dynamic)
  `region` | AWS region (for bucket creation)  | [*](#dynamic)
