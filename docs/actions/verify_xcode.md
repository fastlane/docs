...
> This action was implemented after the recent Xcode attack to make sure<br>you're not using a hacked Xcode installation.<br>http://researchcenter.paloaltonetworks.com/2015/09/novel-malware-xcodeghost-modifies-xcode-infects-apple-ios-apps-and-hits-app-store/
