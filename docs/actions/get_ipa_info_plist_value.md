...
This action, just like the rest of _fastlane_, is fully open source, <a href="https://github.com/fastlane/fastlane/blob/master/fastlane/lib/fastlane/actions/get_ipa_info_plist_value.rb" target="_blank">view the source code on GitHub</a>
