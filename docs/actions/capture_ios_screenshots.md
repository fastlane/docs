...
----|-------------|--------
  ...
  `output_directory` | The directory where to store the screenshots | [*](#dynamic)
  ...
  `app_identifier` | The bundle identifier of the app to uninstall (only needed when enabling reinstall_app) | [*](#dynamic)
