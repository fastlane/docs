...
Great question! Check out the [GitHub Labels](https://github.com/fastlane/fastlane/blob/master/GitHubLabels.md#readme) document for a quick summary of the labels we use and what they mean.
