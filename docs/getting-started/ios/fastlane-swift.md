...
Fastlane.swift currently supports all built-in [fastlane actions](https://docs.fastlane.tools/generated/actions/) and 3rd party [plugins](https://docs.fastlane.tools/generated/available-plugins/). Make sure to update to the most recent _fastlane_ release to try these features.
