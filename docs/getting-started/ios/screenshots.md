...
If you want to implement the custom titles and background, you'll have to setup a `Framefile.json`, more information can be found [here](https://docs.fastlane.tools/generated/actions/frameit/#titles-and-background-optional).
