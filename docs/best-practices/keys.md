...
Install `[sudo] gem install dotenv` or add `dotenv` to your `Gemfile`. More information about the [recommend way to install gems](https://docs.fastlane.tools/getting-started/ios/setup/#use-a-gemfile).
